            ...
            <div className='flex flex-wrap justify-between gap-10 p-5 px-6  md:px-12 max-w-[1280px] mx-auto'>
                <div className='pt-6 gap-10'>
                    ...
                    <div className='text-white font-[Poppins] text-[16px] font-normal leading-[140%] tracking-[0.288px] mt-2 '>
                        ...
                        {/* email */}
                        <a href='mailto:satnpaper@zuperscore.in' className='flex gap-2 mt-1' >
                            ...
                            satnpaper@zuperscore.in
                        </a>

                        {/* location */}
                        <a
                            href='https://www.google.com/maps/search/414,+4th+floor,+Ocean+plaza,+P+Block,+Pocket+A,+Sector+18,+Noida,+Uttar+Pradesh+201301/@28.5695113,77.3258407,17z'
                        ...
                        >
                            ...
                            <h2 className='flex flex-col'>
                                ...
                                <span>414, 4th floor, Ocean plaza, P Block,</span>
                                <span>Pocket A, Sector 18, Noida, Uttar</span>
                                <span>Pradesh 201301</span>
                        ...
                        {/* instragram*/}
                        <h2 className='flex items-center gap-3 mt-4 text-white'>
                            ...
                            <a href="https://wa.me/919220502157"
                                className="text-#FFFFFF"
                                target='_blank'
                                rel='noopener noreferrer'
                            >
